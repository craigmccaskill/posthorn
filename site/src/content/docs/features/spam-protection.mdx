...
Posthorn also ships HMAC-signed [CSRF tokens](/features/api-mode/) (`csrf_secret`, off by default). Operators issue tokens server-side at form-render time; Posthorn verifies the HMAC on submit.
