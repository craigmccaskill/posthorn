...
The 10K default is sized for typical homelab and indie-developer use. Larger deployments can override the cap; the configuration knob is a planned addition.
