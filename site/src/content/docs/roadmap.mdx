...
| AWS SES | HTTP API, SigV4 auth, region-scoped |
...
- **Lifecycle event callbacks** — delivery / bounce / open / click events forwarded to the originating caller with HMAC-signed webhook
