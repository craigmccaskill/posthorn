...
For production, pin to a specific version (`:vX.Y.Z`) and update intentionally. `:latest` is convenient for development. Check the [GHCR package page](https://github.com/craigmccaskill/posthorn/pkgs/container/posthorn) for the current tag set.
