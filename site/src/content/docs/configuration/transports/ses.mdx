...
<Aside type="tip">
SES SigV4 is the most complex auth scheme of any Posthorn transport. The implementation lives in `core/transport/awssigv4.go` and is reusable by any future AWS-signed transport (e.g. SNS, S3).
</Aside>
