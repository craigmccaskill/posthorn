...
| Alert email lands in spam | DomainKeys Identified Mail (DKIM) / Sender Policy Framework (SPF) on the sending domain — same as every other Posthorn recipe | See [DNS](/security/dns/) |
